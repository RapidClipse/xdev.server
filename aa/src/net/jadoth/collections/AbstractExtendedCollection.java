 ...
 * general pupose type (java.util.Collection) is implemented intentionally broken to achieve a certain reduced behaviour,
...
public abstract class AbstractExtendedCollection<E> implements ExtendedCollection<E>
{
	...
	protected abstract int internalCountingAddAll(E[] elements, int offset, int length) throws UnsupportedOperationException;

	protected abstract int internalCountingAddAll(XGettingCollection<? extends E> elements) throws UnsupportedOperationException;

	protected abstract int internalCountingPutAll(E[] elements) throws UnsupportedOperationException;

	protected abstract int internalCountingPutAll(E[] elements, int offset, int length) throws UnsupportedOperationException;

	protected abstract int internalCountingPutAll(final XGettingCollection<? extends E> elements) throws UnsupportedOperationException;
