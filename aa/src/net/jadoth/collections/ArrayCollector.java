...
//	}
	...
	public boolean equals(final XGettingCollection<? extends E> samples, final Equalator<? super E> equalator)
	{
		...
		return JadothArrays.equals(this.data, 0, ((ArrayCollector<?>)samples).data, 0, this.size, (Equalator<Object>)equalator);
	}
	...
	@Override
	public ArrayCollector<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
	...
	@Override
	public ArrayCollector<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
	...
	@Override
	public ArrayCollector<E> shiftBy(final int sourceIndex, final int distance)
	{
		return this.shiftTo(sourceIndex, sourceIndex + distance);
	}

	@Override
	public ArrayCollector<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		return this.shiftTo(sourceIndex, sourceIndex + distance, length);
	}

	@Override
	public ArrayCollector<E> swap(final int indexA, final int indexB) throws IndexOutOfBoundsException, ArrayIndexOutOfBoundsException
	{
		if(indexA >= this.size){
	...
	@Override
	public ArrayCollector<E> swap(final int indexA, final int indexB, final int length)
	{
	...
	@SafeVarargs
	@Override
	public final ArrayCollector<E> setAll(final int offset, final E... elements)
	{
	...
	@Override
	public ArrayCollector<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
	...
	@Override
	public ArrayCollector<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
	...
	@Override
	public ArrayCollector<E> fill(final int offset, final int length, final E element)
	{
...
//	}
	...
	@Override
	public ArrayCollector<E> removeRange(final int startIndex, final int length)
	{
	...
	@Override
	public ArrayCollector<E> retainRange(final int startIndex, final int length)
	{
	...
	@Override
	public E removeAt(final int index) throws IndexOutOfBoundsException, ArrayIndexOutOfBoundsException
	{
		if(index >= this.size){
			throw new IndexBoundsException(this.size, index);
		}
	...
	public static final class OldArrayCollector<E> extends BridgeXList<E>
	{
