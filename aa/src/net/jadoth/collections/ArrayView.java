...
//	}
	...
	public boolean equals(final XGettingCollection<? extends E> samples, final Equalator<? super E> equalator)
	{
		...
		return JadothArrays.equals(this.data, 0, ((ArrayView<?>)samples).data, 0, this.size, (Equalator<Object>)equalator);
	}
	...
	@Override
	public SubListView<E> range(final int fromIndex, final int toIndex)
	{
	...
	public static final class OldArrayView<E> extends OldGettingList<E>
	{
