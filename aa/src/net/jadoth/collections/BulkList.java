...
implements XList<E>, Composition, IdentityEqualityLogic
{
	...
	public static <E> Aggregator<E, BulkList<E>> Builder(final int initialCapacity)
	{
	...
	public static final <E> BulkList<E> New(final int initialCapacity)
	{
		return new BulkList<>(initialCapacity);
	}
...
//	}
	...
	@Override
	public final BulkList<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
	...
	@Override
	public final BulkList<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
	...
	@Override
	public final BulkList<E> shiftBy(final int sourceIndex, final int distance)
	{
		return this.shiftTo(sourceIndex, sourceIndex + distance);
	}

	@Override
	public final BulkList<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		return this.shiftTo(sourceIndex, sourceIndex + distance, length);
	}

	@Override
	public final BulkList<E> swap(final int indexA, final int indexB) throws IndexOutOfBoundsException, ArrayIndexOutOfBoundsException
	{
	...
	@Override
	public final BulkList<E> swap(final int indexA, final int indexB, final int length)
	{
	...
	@SafeVarargs
	@Override
	public final BulkList<E> setAll(final int offset, final E... elements)
	{
	...
	@Override
	public final BulkList<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
	...
	@Override
	public final BulkList<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
	...
	@Override
	public final BulkList<E> fill(final int offset, final int length, final E element)
	{
	...
	@Override
	public final BulkList<E> removeRange(final int startIndex, final int length)
	{
	...
	@Override
	public final BulkList<E> retainRange(final int startIndex, final int length)
	{
	...
	@Override
	public final ListIterator<E> listIterator(final int index) throws IndexBoundsException
	{
	...
	@Override
	public final E at(final int index) throws IndexBoundsException
	{
		validateIndex(this.size, index);
	...
	@Override
	public final boolean set(final int index, final E element) throws IndexBoundsException
	{
		validateIndex(this.size, index);
		this.data[index] = element;
		return false;
	...
	@Override
	public final E setGet(final int index, final E element) throws IndexBoundsException
	{
		validateIndex(this.size, index);
