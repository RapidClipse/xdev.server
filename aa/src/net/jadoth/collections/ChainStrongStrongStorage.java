...
extends AbstractChainKeyValueStorage<K, V, EN>
{
	...
	public final boolean keyContainsAll(final XGettingCollection<? extends K> elements)
	{
		...
		return elements.applies(new Predicate<K>() { @Override public boolean test(final K e) {
			return ChainStrongStrongStorage.this.keyContains(e);
		}});
	}
	...
	public final boolean keyRngContainsAll(final int offset, final int length, final XGettingCollection<? extends K> elements)
	{
		...
		// iterate by predicate function
		if(length < 0){
			return elements.applies(new Predicate<K>() {
				@Override public boolean test(final K e) {
					int len = length;
	...
	public final int keyCount(final K sample, final Equalator<? super K> equalator)
	{
		int count = 0;
		for(EN e = this.head.next; e != null; e = e.next){
			if(equalator.equal(e.key(), sample)) count++;
		}
		return count;
	}
	...
	@Override
	public final <C extends Procedure<? super K>> C keyIntersect(
	...
	@Override
	public final <C extends Procedure<? super K>> C keyExcept(
		final XGettingCollection<? extends K> samples,
		final Equalator<? super K> equalator,
		final C target
	)
	...
	@Override
	public final <C extends Procedure<? super K>> C keyUnion(
		final XGettingCollection<? extends K> samples,
		final Equalator<? super K> equalator,
		final C target
	)
	{
		 ...
		 * - chain's equal element instances must be added, not samples'.
		 */
		samples.iterate(new Procedure<K>(){
			@Override public void accept(final K e) {
	...
	@Override
	public final <C extends Procedure<? super K>> C keyRngIntersect(
		final int offset,
		      int length,
		final XGettingCollection<? extends K> samples,
		final Equalator<? super K> equalator,
	...
	@Override
	public final <C extends Procedure<? super K>> C keyRngExcept(
		final int offset,
		      int length,
		final XGettingCollection<? extends K> samples,
		final Equalator<? super K> equalator,
	...
	@Override
	public final <C extends Procedure<? super K>> C keyRngUnion(
		final int offset,
		final int length,
		final XGettingCollection<? extends K> samples,
		final Equalator<? super K> equalator,
...
//			final K[] array = ((AbstractSimpleArrayCollection<K>)samples).internalGetStorageArray();
			final K[] array = AbstractSimpleArrayCollection.internalGetStorageArray((AbstractSimpleArrayCollection<?>)samples);
			final int size = Jadoth.to_int(samples.size());
	...
	@Override
	public final <C extends Procedure<? super K>> C keyCopyTo(final C target)
	{
		for(EN e = this.head.next; e != null; e = e.next){
			target.accept(e.key());
		}
	...
	@Override
	public final <C extends Procedure<? super K>> C keyRngCopyTo(final int offset, int length, final C target)
	{
		final EN first;
		if((first = this.getRangeChainEntry(offset, length)) == null){
			return target;
	...
	@Override
	public final <C extends Procedure<? super K>> C keyCopySelection(final C target, final int... indices)
	{
	...
	@Override
	public final <C extends Procedure<? super K>> C keyCopyTo(final C target, final Predicate<? super K> predicate)
	{
		try {
			for(EN entry = this.head.next; entry != null; entry = entry.next) {
	...
	@Override
	public final <C extends Procedure<? super K>> C keyRngCopyTo(
		final int offset,
		      int length,
		final C target,
	...
	@Override
	public final K keyGet(final int index)
	{
	...
	@Override
	public final void keyIterate(final Procedure<? super K> procedure)
	{
		try {
	...
	@Override
	public final void keyRngIterate(final int offset, int length, final Procedure<? super K> procedure)
	{
		EN e;
	...
	@Override
	public final void keyIterate(final Predicate<? super K> predicate, final Procedure<? super K> procedure)
	{
		try {
			for(EN e = this.head.next; e != null; e = e.next) {
				if(predicate.test(e.key())) {
	...
	@Override
	public final <C extends Procedure<? super K>> C keyDistinct(final C target)
	{
		return this.keyRngDistinct(Jadoth.to_int(this.parent.size()) - 1, Jadoth.to_int(this.parent.size()), target);
	}

	@Override
	public final <C extends Procedure<? super K>> C keyDistinct(final C target, final Equalator<? super K> equalator)
	{
		return this.keyRngDistinct(Jadoth.to_int(this.parent.size()) - 1, Jadoth.to_int(this.parent.size()), target, equalator);
	}

	@Override
	public final <C extends Procedure<? super K>> C keyRngDistinct(final int offset, int length, final C target)
	{
	...
	@Override
	public final <C extends Procedure<? super K>> C keyRngDistinct(
		final int offset,
		      int length,
		final C target,
		final Equalator<? super K> equalator
	...
	@Override
	public final K keyRemove(final int index)
	{
		final EN e;
	...
	@Override
	public final int keyRngRemoveNull(int offset, final int length)
	{
		EN e;
	...
	@Override
	public final K keyRngRetrieve(final int offset, int length, final K element)
	{
		EN e;
	...
	public final int keyRemoveAll(final XGettingCollection<? extends K> elements)
	{
		...
		return elements.iterate(new Aggregator<K, Integer>(){
	...
	@Override
	public final int keyProcess(final Procedure<? super K> procedure)
	{
		final AbstractChainCollection<KeyValue<K,V>, K, V, EN> parent = this.parent;
		int removeCount = 0;
		try {
	...
	@Override
	public final int keyRngProcess(int offset, final int length, final Procedure<? super K> procedure)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null) return 0;
		int removeCount = 0;
	...
	@Override
	public final int keyMoveRange(int offset, final int length, final Procedure<? super K> target)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null) return 0;
		final AbstractChainCollection<KeyValue<K,V>, K, V, EN> parent = this.parent;
	...
	@Override
	public final int keyMoveSelection(final Procedure<? super K> target, final int... indices)
	{
	...
	@Override
	public final int keyMoveTo(final Procedure<? super K> target, final Predicate<? super K> predicate)
	{
		int removeCount = 0;
		final AbstractChainCollection<KeyValue<K,V>, K, V, EN> parent = this.parent;
		for(EN e = this.head.next; e != null; e = e.next){
	...
	public final int keyRngMoveTo(
		      int offset,
		final int length,
		final Procedure<? super K> target,
		final Predicate<? super K> predicate
	)
	{
		final int bound = offset + length;
	...
	@Override
	public final VarString keyAppendTo(final VarString vc, final char seperator)
	{
		if(this.head.next == null){
			return vc;
		}
		for(EN entry = this.head; (entry = entry.next) != null;){
			vc.add(entry.key()).add(seperator);
		}
		return vc.deleteLast();
	}

	@Override
	public final VarString keyAppendTo(final VarString vc, final String seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyAppendTo()
	}
	...
	@Override
	public final VarString keyAppendTo(final VarString vc, final BiProcedure<VarString, ? super K> keyAppender, final char seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyAppendTo()
	}

	@Override
	public final VarString keyAppendTo(final VarString vc, final BiProcedure<VarString, ? super K> keyAppender, final String seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyAppendTo()
	}
	...
	@Override
	public final VarString keyRngAppendTo(final int offset, final int length, final VarString vc, final char seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyRngAppendTo()
	}

	@Override
	public final VarString keyRngAppendTo(final int offset, final int length, final VarString vc, final String seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyRngAppendTo()
	}
	...
	@Override
	public final VarString keyRngAppendTo(final int offset, final int length, final VarString vc, final BiProcedure<VarString, ? super K> keyAppender, final char seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyRngAppendTo()
	}

	@Override
	public final VarString keyRngAppendTo(final int offset, final int length, final VarString vc, final BiProcedure<VarString, ? super K> keyAppender, final String seperator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME ChainKeyValueStorage<K,V,EN>#keyRngAppendTo()
	}
...
//	// valuesMerge recursive (faster than iterative in some cases but causes stack overflow for large chains, of course)
//	private static <K, V, C extends ChainEntry<K,V>> C valuesMerge0(final C c1, final C c2, final Comparator<? super V> cmp)
//	{
//		if(c1 == null) return c2;
//		if(c2 == null) return c1;
//		if(cmp.compare(c1.value(), c2.value()) < 0) {
//			c1.next = valuesMerge0(c1.next, c2, cmp);
//			return c1;
//		}
//		c2.next = valuesMerge0(c1, c2.next, cmp);
//		return c2;
//	}

	// valuesMerge iterative
	private static <K, V, EN extends AbstractChainEntry<KeyValue<K,V>, K, V, EN>> EN valuesMerge1(EN c1, EN c2, final Comparator<? super V> cmp)
	{
		if(c1 == null) return c2;
		if(c2 == null) return c1;
	...
	@Override
	public final ListIterator<V> valuesListIterator(final int index)
	{
		return new ValueListItr(index);
	}
	...
	public final boolean valuesEqualsContent(final XGettingCollection<? extends V> other, final Equalator<? super V> equalator)
	{
		...
		if(other instanceof AbstractSimpleArrayCollection<?>){
			final int otherSize = Jadoth.to_int(other.size());
			final V[] otherData = AbstractSimpleArrayCollection.internalGetStorageArray((AbstractSimpleArrayCollection<?>)other);
			EN entry = this.head.next;
			for(int i = 0; i < otherSize; i++, entry = entry.next){
	...
	public final boolean valuesContainsAll(final V[] elements, final int elementsOffset, final int elementsLength)
	{
		...
		final int d;
		if((d = ChainStorageStrong.validateArrayIteration(elements, elementsOffset, elementsLength)) == 0) return true;
		final int elementsBound = elementsOffset + elementsLength;
	...
	public final boolean valuesContainsAll(final XGettingCollection<? extends V> elements)
	{
		...
		// iterate by predicate function
		return elements.applies(new Predicate<V>() { @Override public boolean test(final V e) {
			return ChainStrongStrongStorage.this.valuesContains(e);
		}});
	}
	...
	)
	{
		...
		// iterate by predicate function
		if(length < 0){
			return samples.applies(new Predicate<V>() { @Override public boolean test(final V e) {
				int len = length;
				for(EN entry = first; len ++< 0; entry = entry.prev){
					if(equalator.equal(entry.value(), e)){
						return true;
	...
	public final int valuesCount(final V sample, final Equalator<? super V> equalator)
	{
		int count = 0;
		for(EN e = this.head.next; e != null; e = e.next){
			if(equalator.equal(e.value(), sample)) count++;
		}
		return count;
	}
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesIntersect(
		final XGettingCollection<? extends V> samples,
		final Equalator<? super V> equalator,
		final C target
	)
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesExcept(
		final XGettingCollection<? extends V> samples,
		final Equalator<? super V> equalator,
		final C target
	)
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesUnion(
		final XGettingCollection<? extends V> samples,
		final Equalator<? super V> equalator,
		final C target
	)
	{
		 ...
		 * - chain's equal element instances must be added, not samples'.
		 */
		samples.iterate(new Procedure<V>(){ @Override public void accept(final V e) {
			// local reference to AIC field
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesRngIntersect(
		final int offset,
		      int length,
		final XGettingCollection<? extends V> samples,
		final Equalator<? super V> equalator,
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesRngExcept(
		final int offset,
		      int length,
		final XGettingCollection<? extends V> samples,
		final Equalator<? super V> equalator,
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesRngUnion(
		final int offset,
		final int length,
		final XGettingCollection<? extends V> samples,
		final Equalator<? super V> equalator,
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesCopyTo(final C target)
	{
		for(EN e = this.head.next; e != null; e = e.next){
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesRngCopyTo(final int offset, int length, final C target)
	{
		final EN first;
		if((first = this.getRangeChainEntry(offset, length)) == null) return target;
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesCopySelection(final C target, final int... indices)
	{
		final int length = indices.length, size = Jadoth.to_int(this.parent.size());
	...
	@Override
	public final int valuesCopyToArray(final int offset, int length, final Object[] target, final int targetOffset)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null) return 0;
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesCopyTo(final C target, final Predicate<? super V> predicate)
	{
		try {
			for(EN e = this.head.next; e != null; e = e.next) {
				if(predicate.test(e.value())) {
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesRngCopyTo(
		final int offset,
		      int length,
		final C target,
	...
	@Override
	public final V valuesGet(final int index)
	{
	...
	{
		EN e;
		if((e = this.head.next) == null) return null;
	...
	@Override
	public final void valuesIterate(final Procedure<? super V> procedure)
	{
		try {
			for(EN e = this.head.next; e != null; e = e.next) {
	...
	@Override
	public final void valuesRngIterate(final int offset, int length, final Procedure<? super V> procedure)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null){
			return;
	...
	@Override
	public final void valuesIterate(final Predicate<? super V> predicate, final Procedure<? super V> procedure)
	{
		try {
			for(EN e = this.head.next; e != null; e = e.next) {
				if(predicate.test(e.value())) {
	...
	{
		EN e;
		if((e = this.head.next) == null) return -1;
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesDistinct(final C target)
	{
		return this.valuesRngDistinct(Jadoth.to_int(this.parent.size()) - 1, Jadoth.to_int(this.parent.size()), target);
	}

	@Override
	public final <C extends Procedure<? super V>> C valuesDistinct(final C target, final Equalator<? super V> equalator)
	{
		return this.valuesRngDistinct(Jadoth.to_int(this.parent.size()) - 1, Jadoth.to_int(this.parent.size()), target, equalator);
	}

	@Override
	public final <C extends Procedure<? super V>> C valuesRngDistinct(final int offset, int length, final C target)
	{
		if(length == 0) return target; // required for correctness of direction reversion
	...
	@Override
	public final <C extends Procedure<? super V>> C valuesRngDistinct(
		final int offset,
		      int length,
		final C target,
		final Equalator<? super V> equalator
	...
	@Override
	public final VarString valuesAppendTo(final VarString vc, final char seperator)
	{
		if(this.head.next == null){
			return vc;
		}
		for(EN entry = this.head; (entry = entry.next) != null;){
			vc.add(entry.value()).add(seperator);
		}
		return vc.deleteLast();
	}

	@Override
	public final VarString valuesAppendTo(final VarString vc, final String seperator)
	{
	...
	@Override
	public final VarString valuesAppendTo(final VarString vc, final BiProcedure<VarString, ? super V> appender, final char seperator)
	{
		EN entry;
		if((entry = this.head.next) == null){
			return vc;
		...
		appender.accept(vc, entry.value());
		while((entry = entry.next) != null){
			appender.accept(vc.append(seperator), entry.value());
		}
		return vc;
	}

	@Override
	public final VarString valuesAppendTo(final VarString vc, final BiProcedure<VarString, ? super V> appender, final String seperator)
	{
		if(seperator == null || seperator.isEmpty()){
	...
	@Override
	public final VarString valuesRngAppendTo(int offset, final int length, final VarString vc, final char seperator)
	{
		EN entry;
		if((entry = this.getRangeChainEntry(offset, length)) == null){
			return vc;
		...
		if(length > 0){
			for(; ++offset != bound; entry = entry.next){
				vc.append(seperator).add(entry.value());
			}
		}
		else {
			for(; --offset != bound; entry = entry.prev){
	...
	@Override
	public final VarString valuesRngAppendTo(int offset, final int length, final VarString vc, final String seperator)
	{
		if(seperator == null || seperator.isEmpty()){
	...
	@Override
	public final V valuesRemove(final int index)
	{
		final EN e;
		(e = this.getChainEntry(index)).removeFrom(this.parent);
		return e.value();
	...
	{
		final int d;
		if((d = JadothArrays.validateArrayRange(samples, samplesOffset, samplesLength)) == 0) return 0;
		final EN first;
		if((first = this.getRangeChainEntry(offset, length)) == null) return 0;
	...
	public final int valuesRemoveAll(final XGettingCollection<? extends V> elements)
	{
		...
		return elements.iterate(new Aggregator<V, Integer>(){
			private int removeCount = 0;
			@Override public void accept(final V e) {
	...
	public final int valuesRemoveAll(final XGettingCollection<? extends V> samples, final Equalator<? super V> equalator)
	{
		...
		return samples.iterate(new Aggregator<V, Integer>(){
			private int removeCount = 0;
			@Override public void accept(final V e) {
	...
	@Override
	public final int valuesProcess(final Procedure<? super V> procedure)
	{
		final AbstractChainCollection<KeyValue<K,V>, K, V, EN> parent = this.parent;
		int removeCount = 0;
		try {
	...
	@Override
	public final int valuesRngProcess(int offset, final int length, final Procedure<? super V> procedure)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null) return 0;
		int removeCount = 0;
	...
	@Override
	public final int valuesMoveRange(int offset, final int length, final Procedure<? super V> target)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null) return 0;
		final AbstractChainCollection<KeyValue<K,V>, K, V, EN> parent = this.parent;
	...
	@Override
	public final int valuesMoveSelection(final Procedure<? super V> target, final int... indices)
	{
		final int indicesLength = indices.length, size = Jadoth.to_int(this.parent.size());
	...
	@Override
	public final int valuesMoveTo(final Procedure<? super V> target, final Predicate<? super V> predicate)
	{
		int removeCount = 0;
		try {
			final AbstractChainCollection<KeyValue<K,V>, K, V, EN> parent = this.parent;
	...
	public final int valuesRngMoveTo(
		      int offset,
		final int length,
		final Procedure<? super V> target,
		final Predicate<? super V> predicate
	)
	{
		final int bound = offset + length;
	...
	public final void valuesSort(final Comparator<? super V> comparator)
	{
		...
		if(comparator == null) throw new NullPointerException();
		if(Jadoth.to_int(this.parent.size()) <= 1) return; // empty or trivial chain is always sorted
	...
	@Override
	public final V valuesSet(final int offset, final V value)
	{
		return this.getChainEntry(offset).setValue(value);
	}

	@Override
	public final void valuesSet(final int offset, final V[] elements)
	{
		EN e = this.getRangeChainEntry(offset, elements.length);
		for(int i = 0; i < elements.length; i++){
	...
	@Override
	public final void valuesSet(final int offset, final V[] elements, final int elementsOffset, final int elementsLength)
	{
		EN e = this.getRangeChainEntry(offset, elementsLength);
		final int d = JadothArrays.validateArrayRange(elements, offset, elementsLength);
		for(int i = elementsOffset, bound = elementsOffset + elementsLength; i != bound; i+=d){
	...
	@Override
	public final void valuesFill(int offset, final int length, final V element)
	{
		EN e;
		if((e = this.getRangeChainEntry(offset, length)) == null){
			return;
	...
	@Override
	public final boolean valuesRngRemoveOne(final int offset, final int length, final V valuesue)
	{
