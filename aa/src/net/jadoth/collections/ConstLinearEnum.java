...
import net.jadoth.collections.old.OldGettingSet;
...
//	{
//		return AbstractArrayStorage.find((E[])this.data, this.data.length, sample, equalator);
//	}
...
//	}
	...
	@Override
	public ConstLinearEnum<E> view(final int lowIndex, final int highIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME Auto-generated method stub, not implemented yet
	}

	@Override
	public ConstLinearEnum<E> range(final int fromIndex, final int toIndex)
	{
...
//		return new SubListView<>(this, fromIndex, toIndex);
	...
	public static final class OldConstEnum<E> extends OldGettingSet<E>
	{
