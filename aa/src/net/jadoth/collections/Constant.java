...
public class Constant<E> implements XImmutableList<E>, XImmutableEnum<E>, XReferencing<E>
{
	...
	@Override
	public final Constant<E> range(final int fromIndex, final int toIndex)
	{
		if(fromIndex != 0){
			throw new IndexOutOfBoundsException();
		}
	...
	@Override
	public final Constant<E> view(final int lowIndex, final int highIndex)
	{
		if(lowIndex != 0){
			throw new IndexOutOfBoundsException();
		}
...
//				return equalator.equal(element, e);
//			}
//		});
//	}
	...
	final class OldConstant implements OldList<E>, OldSet<E>
	{
		...
		{
			return Constant.this.indexOf((E)o); // safe because of referencial comparison
		}
		...
		{
			return Constant.this.lastIndexOf((E)o); // safe because of referencial comparison
		}
		...
		{
			if(fromIndex != 0 || toIndex != 0){ // admitted quick&dirty checks for a rather academic use case anyway
