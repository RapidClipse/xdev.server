 ...
 * When designing an application or library, the primary target should be to properly identify the concearns and use
...
public final class DownwrapList<E> implements XList<E>
{
	...
	public void accept(final E element)
	{
		if(this.subject instanceof Procedure<?>){
			((Procedure<E>)this.subject).accept(element);
		}
		throw new UnsupportedOperationException();
	}
...
//	}
	...
	@Override
	public DownwrapList<E> fill(final int offset, final int length, final E element)
	{
...
//	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> removeRange(final int offset, final int length)
	{
		if(this.subject instanceof XProcessingSequence<?>){
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> retainRange(final int offset, final int length)
	{
		if(this.subject instanceof XProcessingSequence<?>){
...
//	}
	...
	{
		if(this.subject instanceof XSettingList<?>){
			return ((XSettingList<E>)this.subject).modify(mapper);
		}
		throw new UnsupportedOperationException();
	}
...
//	}
	...
	@SafeVarargs
	@Override
	public final DownwrapList<E> setAll(final int offset, final E... elements)
	{
		if(this.subject instanceof XSettingList<?>){
	...
	@Override
	public DownwrapList<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
		if(this.subject instanceof XSettingList<?>){
	...
	@Override
	public DownwrapList<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
		if(this.subject instanceof XSettingList<?>){
	...
	@Override
	public XList<E> range(final int fromIndex, final int toIndex)
	{
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
		if(this.subject instanceof XSortableSequence<?>){
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
		if(this.subject instanceof XSortableSequence<?>){
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> shiftBy(final int sourceIndex, final int distance)
	{
		if(this.subject instanceof XSortableSequence<?>){
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		if(this.subject instanceof XSortableSequence<?>){
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> swap(final int indexA, final int indexB)
	{
		if(this.subject instanceof XSortableSequence<?>){
	...
	@SuppressWarnings("unchecked")
	@Override
	public DownwrapList<E> swap(final int indexA, final int indexB, final int length)
	{
		if(this.subject instanceof XSortableSequence<?>){
	...
	public static final class OldWrapperList<E> extends BridgeXList<E>
	{
