...
public final class EmptyTable<K,V> implements XImmutableTable<K, V>
{
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingMap<K,V>#old
	}

	@Override
	public XImmutableTable.Bridge<K, V> oldMap()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME EmptyTable#oldMap()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#toArray()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#equality()
	}

	@Override
	public boolean equals(final XGettingCollection<? extends KeyValue<K, V>> samples, final Equalator<? super KeyValue<K, V>> equalator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#equals()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#equalsContent()
	}

	@Override
	public boolean nullContained()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#nullContained()
	}

	@Override
	public boolean containsId(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#containsId()
	}

	@Override
	public boolean contains(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#contains()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#containsAll()
	}

	@Override
	public boolean applies(final Predicate<? super KeyValue<K, V>> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#applies()
	}

	@Override
	public int count(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#count()
	}

	@Override
	public int countBy(final Predicate<? super KeyValue<K, V>> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#count()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#search()
	}

	@Override
	public KeyValue<K, V> seek(final KeyValue<K, V> sample)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#seek()
	}

	@Override
	public KeyValue<K, V> max(final Comparator<? super KeyValue<K, V>> comparator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#max()
	}

	@Override
	public KeyValue<K, V> min(final Comparator<? super KeyValue<K, V>> comparator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#min()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T distinct(final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#distinct()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T distinct(final T target, final Equalator<? super KeyValue<K, V>> equalator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#distinct()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T copyTo(final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#copyTo()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T filterTo(final T target, final Predicate<? super KeyValue<K, V>> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#filterTo()
	}
	...
	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T union(final XGettingCollection<? extends KeyValue<K, V>> other, final Equalator<? super KeyValue<K, V>> equalator, final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#union()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T intersect(final XGettingCollection<? extends KeyValue<K, V>> other, final Equalator<? super KeyValue<K, V>> equalator, final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#intersect()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T except(final XGettingCollection<? extends KeyValue<K, V>> other, final Equalator<? super KeyValue<K, V>> equalator, final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<KeyValue<K,V>>#except()
	}
	...
	@Override
	public XGettingEnum<KeyValue<K, V>> view(final int lowIndex, final int highIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingEnum<KeyValue<K,V>>#view()
	}

	@Override
	public XGettingEnum<KeyValue<K, V>> range(final int lowIndex, final int highIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingEnum<KeyValue<K,V>>#range()
	}

	@Override
	public KeyValue<K, V> at(final int index)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#get()
	}

	@Override
	public KeyValue<K, V> first()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#first()
	}

	@Override
	public KeyValue<K, V> last()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#last()
	}

	@Override
	public KeyValue<K, V> poll()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#poll()
	}

	@Override
	public KeyValue<K, V> peek()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#peek()
	}

	@Override
	public int maxIndex(final Comparator<? super KeyValue<K, V>> comparator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#maxIndex()
	}

	@Override
	public int minIndex(final Comparator<? super KeyValue<K, V>> comparator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#minIndex()
	}

	@Override
	public int indexOf(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#indexOf()
	}

	@Override
	public int indexBy(final Predicate<? super KeyValue<K, V>> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#indexOf()
	}

	@Override
	public int lastIndexOf(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#lastIndexOf()
	}

	@Override
	public int lastIndexBy(final Predicate<? super KeyValue<K, V>> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#lastIndexOf()
	}

	@Override
	public int scan(final Predicate<? super KeyValue<K, V>> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#scan()
	}

	@Override
	public boolean isSorted(final Comparator<? super KeyValue<K, V>> comparator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingSequence<KeyValue<K,V>>#isSorted()
	}

	@Override
	public <T extends Procedure<? super KeyValue<K, V>>> T copySelection(final T target, final int... indices)
	{
	...
	final class Values implements XImmutableTable.Values<K, V>
	{
		...
		@Override
		public final XImmutableList<V> range(final int fromIndex, final int toIndex)
		{
		...
		@Override
		public final XImmutableList<V> view(final int lowIndex, final int highIndex)
		{
		...
		@Override
		public final int indexOf(final V element)
		{
		...
		@Override
		public final int lastIndexOf(final V element)
		{
		...
		@Override
		public final int count(final V element)
		{
		...
		@Override
		public final <T extends Procedure<? super V>> T union(final XGettingCollection<? extends V> other, final Equalator<? super V> equalator, final T target)
		{
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<V>#old()
		}
	...
	final class Keys implements XImmutableTable.Keys<K, V>
	{
		...
		@Override
		public final XImmutableEnum<K> range(final int fromIndex, final int toIndex)
		{
		...
		@Override
		public final XImmutableEnum<K> view(final int lowIndex, final int highIndex)
		{
		...
		@Override
		public final <T extends Procedure<? super K>> T distinct(final T target)
		{
			return X.<K>empty().distinct(target);
		}

		@Override
		public final <T extends Procedure<? super K>> T distinct(final T target, final Equalator<? super K> equalator)
		{
			return X.<K>empty().distinct(target, equalator);
		}

		@Override
		public final <T extends Procedure<? super K>> T copyTo(final T target)
		{
			return X.<K>empty().copyTo(target);
		}

		@Override
		public final <T extends Procedure<? super K>> T filterTo(final T target, final Predicate<? super K> predicate)
		{
		...
		@Override
		public final <T extends Procedure<? super K>> T union(final XGettingCollection<? extends K> other, final Equalator<? super K> equalator, final T target)
		{
			return X.<K>empty().union(other, equalator, target);
		}

		@Override
		public final <T extends Procedure<? super K>> T intersect(final XGettingCollection<? extends K> other, final Equalator<? super K> equalator, final T target)
		{
			return X.<K>empty().intersect(other, equalator, target);
		}

		@Override
		public final <T extends Procedure<? super K>> T except(final XGettingCollection<? extends K> other, final Equalator<? super K> equalator, final T target)
		{
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XGettingCollection<K>#old()
		}
