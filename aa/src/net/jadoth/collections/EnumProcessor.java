...
//	}
	...
	@Override
	public final XGettingEnum<E> range(final int lowIndex, final int highIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME EnumProcessor#range
	}
...
//	}
	...
	@Override
	public final EnumProcessor<E> removeRange(final int startIndex, final int length)
	{
	...
	@Override
	public final EnumProcessor<E> retainRange(final int startIndex, final int length)
	{
...
//	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME EnumProcessor#view
	}
