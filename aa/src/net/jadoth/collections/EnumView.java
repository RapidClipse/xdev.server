...
//	}
	...
	@Override
	public XGettingEnum<E> view(final int lowIndex, final int highIndex)
	{
...
//		return new SubListView<>(this, lowIndex, highIndex);
	...
	@Override
	public XGettingEnum<E> range(final int fromIndex, final int toIndex)
	{
	...
	public static final class OldEnumView<E> extends OldGettingSet<E>
	{
