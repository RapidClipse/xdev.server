...
//	}
	...
	{
		if(samples == null || !(samples instanceof EqBulkList<?>) || Jadoth.to_int(samples.size()) != this.size) return false;
	...
	@Override
	public EqBulkList<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
	...
	@Override
	public EqBulkList<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
	...
	@Override
	public EqBulkList<E> shiftBy(final int sourceIndex, final int distance)
	{
		return this.shiftTo(sourceIndex, sourceIndex + distance);
	}

	@Override
	public EqBulkList<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		return this.shiftTo(sourceIndex, sourceIndex + distance, length);
	}

	@Override
	public EqBulkList<E> swap(final int indexA, final int indexB) throws IndexOutOfBoundsException, ArrayIndexOutOfBoundsException
	{
		if(indexA >= this.size){
	...
	@Override
	public EqBulkList<E> swap(final int indexA, final int indexB, final int length)
	{
	...
	@SafeVarargs
	@Override
	public final EqBulkList<E> setAll(final int offset, final E... elements)
	{
	...
	@Override
	public EqBulkList<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
	...
	@Override
	public EqBulkList<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
	...
	@Override
	public EqBulkList<E> fill(final int offset, final int length, final E element)
	{
...
//	}
	...
	@Override
	public EqBulkList<E> removeRange(final int startIndex, final int length)
	{
	...
	@Override
	public EqBulkList<E> retainRange(final int startIndex, final int length)
	{
	...
	public static final class OldBulkList<E> extends BridgeXList<E>
	{
