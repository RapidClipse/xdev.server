...
implements XImmutableEnum<E>, HashCollection<E>, Composition
{
	...
	{
		return New(JadothHash.<E>hashEqualityValue(), DEFAULT_HASH_FACTOR, entries);
	}
	...
	{
		return New(JadothHash.<E>hashEqualityValue(), hashDensity, entries);
	}
	...
	final void internalAddAll(final XGettingCollection<? extends E> elements)
	{
		elements.iterate(new Procedure<E>(){ @Override public void accept(final E e){
			EqConstHashEnum.this.internalAdd(e);
		}});
	}
	...
	public final Predicate<E> predicateContains()
	{
		return new Predicate<E>(){ @Override public boolean test(final E element) {
			return EqConstHashEnum.this.contains(element);
		}};
	}
	...
	@Override
	public final XImmutableEnum<E> range(final int lowIndex, final int highIndex)
	{
