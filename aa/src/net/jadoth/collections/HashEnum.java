...
implements XEnum<E>, HashCollection<E>, Composition, IdentityEqualityLogic
{
	...
	public final Predicate<E> predicateContains()
	{
		return new Predicate<E>(){ @Override public boolean test(final E element) {
			return HashEnum.this.contains(element);
		}};
	}
	...
	@Override
	public final EnumView<E> view(final int lowIndex, final int highIndex)
	{
	...
	@Override
	public final HashEnum<E> removeRange(final int startIndex, final int length)
	{
	...
	@Override
	public final HashEnum<E> retainRange(final int startIndex, final int length)
	{
	...
	@Override
	public final HashEnum<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
	...
	@Override
	public final HashEnum<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
	...
	@Override
	public final HashEnum<E> shiftBy(final int sourceIndex, final int distance)
	{
	...
	@Override
	public final HashEnum<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
	...
	@Override
	public final HashEnum<E> swap(final int indexA, final int indexB)
	{
	...
	@Override
	public final HashEnum<E> swap(final int indexA, final int indexB, final int length)
	{
	...
	@SafeVarargs
	@Override
	public final HashEnum<E> setAll(final int index, final E... elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME EqHashTable.Entries#set()
	}

	@Override
	public final HashEnum<E> set(final int index, final E[] elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME EqHashTable.Entries#set()
	}

	@Override
	public final HashEnum<E> set(final int index, final XGettingSequence<? extends E> elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME EqHashTable.Entries#set()
	}
