 ...
 *
 */
public final class HashMapIdObject<E> implements Sized, OptimizableCollection, Composition
{
	///////////////////////////////////////////////////////////////////////////
	// static methods //
	///////////////////
	...
	public final int iterateObjects(final Procedure<? super E> procedure)
	{
		for(Entry<E> entry : this.hashSlots){
			for(; entry != null; entry = entry.link){
	...
	public final int iterateKeys(final Procedure<? super Long> procedure)
	{
		for(Entry<E> entry : this.hashSlots){
			for(; entry != null; entry = entry.link){
	...
	public final int iterate(final Procedure<? super KeyValue<Long, E>> procedure)
	{
		for(Entry<E> entry : this.hashSlots){
			for(; entry != null; entry = entry.link){
