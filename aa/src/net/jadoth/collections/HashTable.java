...
implements XTable<K,V>, HashCollection<K>, Composition, IdentityEqualityLogic
{
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME HashTable#old()
	}
	...
	public final Procedure<KeyValue<K,V>> procedureRemoveEntry()
	{
		return new Procedure<KeyValue<K,V>>(){
			@Override public void accept(final KeyValue<K,V> entry) {
				HashTable.this.removeKey(entry.key());
			}}
		;
	}
	...
	public final Predicate<KeyValue<K,V>> predicateContainsEntry()
	{
		return new Predicate<KeyValue<K,V>>(){ @Override public boolean test(final KeyValue<K,V> entry) {
			...
			if((kv = HashTable.this.getEntry(entry.key())) == null) return false;
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#range()
	}

	@Override
	public final XGettingEnum<KeyValue<K,V>> view(final int lowIndex, final int highIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#view()
	}
	...
	{
		return HashTable.this.chain.hasDistinctValues(equalator);
	}
	...
	{
		return HashTable.this.chain.applies(predicate);
	}
	...
	public final KeyValue<K, V> seek(final KeyValue<K, V> sample)
	{
		...
		// search for element by hash
		for(ChainMapEntryLinkedStrongStrong<K,V> e = HashTable.this.slots[System.identityHashCode(sample.key()) & HashTable.this.range]; e != null; e = e.link){
			if(e.key() == sample.key()){
				return e;
			}
		}
	...
	public final int removeAll(final XGettingCollection<? extends KeyValue<K,V>> elements)
	{
		...
		elements.iterate(HashTable.this.procedureRemoveEntry());
	...
	@Override
	public final HashTable<K,V> removeRange(final int startIndex, final int length)
	{
	...
	@Override
	public final HashTable<K,V> retainRange(final int startIndex, final int length)
	{
	...
	@Override
	public final HashTable<K,V> shiftTo(final int sourceIndex, final int targetIndex)
	{
	...
	@Override
	public final HashTable<K,V> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
	...
	@Override
	public final HashTable<K,V> shiftBy(final int sourceIndex, final int distance)
	{
	...
	@Override
	public final HashTable<K,V> shiftBy(final int sourceIndex, final int distance, final int length)
	{
	...
	@Override
	public final HashTable<K,V> swap(final int indexA, final int indexB)
	{
	...
	@Override
	public final HashTable<K,V> swap(final int indexA, final int indexB, final int length)
	{
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#input()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#inputAll()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#insert()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#insertAll()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#prepend()
	}

	@Override
	public final boolean preput(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#preput()
	}

	@Override
	public final boolean nullInput(final int index)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#nullInput()
	}

	@Override
	public final boolean nullInsert(final int index)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#nullInsert()
	}

	@Override
	public final boolean nullPrepend()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#nullPrepend()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#prependAll()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#nullPreput()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#preputAll()
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#setGet()
	}

	@Override
	public final void setFirst(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#setFirst()
	}

	@Override
	public final void setLast(final KeyValue<K, V> element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#setLast()
	}

	@SafeVarargs
	@Override
	public final HashTable<K,V> setAll(final int index, final KeyValue<K, V>... elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#set()
	}

	@Override
	public final HashTable<K,V> set(final int index, final KeyValue<K, V>[] elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#set()
	}

	@Override
	public final HashTable<K,V> set(final int index, final XGettingSequence<? extends KeyValue<K, V>> elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Entries#set()
	}
	...
	public final class Keys implements XTable.Keys<K, V>, HashCollection<K>
	{
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#range()
		}

		@Override
		public final XGettingEnum<K> view(final int lowIndex, final int highIndex)
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#view()
		}
		...
		public final boolean hasDistinctValues(final Equalator<? super K> equalator)
		{
			...
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#hasDistinctValues()
		}
		...
		{
			return elements.applies(HashTable.this.predicateContainsKey());
		}
		...
		{
			final int oldSize = HashTable.this.size;
			elements.iterate(HashTable.this.procedureRemoveKey());
			return oldSize - HashTable.this.size;
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#input()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#inputAll()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#insert()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#insertAll()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#prepend()
		}

		@Override
		public final boolean preput(final K element)
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#preput()
		}

		@Override
		public final boolean nullInput(final int index)
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#nullInput()
		}

		@Override
		public final boolean nullInsert(final int index)
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#nullInsert()
		}

		@Override
		public final boolean nullPrepend()
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#nullPrepend()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#prependAll()
		}
		...
		public final boolean nullPreput()
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#nullPreput()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#preputAll()
		}
		...
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#setGet()
		}

		@Override
		public final void setFirst(final K element)
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#setFirst()
		}

		@Override
		public final void setLast(final K element)
		{
			throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME HashTable.Keys#setLast()
		}
	...
	public final class Values implements XTable.Values<K, V>
	{
		...
		public final boolean hasDistinctValues()
		{
			return HashTable.this.chain.valuesHasDistinctValues();
		}

		@Override
		public final boolean hasDistinctValues(final Equalator<? super V> equalator)
		{
			return HashTable.this.chain.valuesHasDistinctValues(equalator);
		}
		...
		{
			// (22.05.2011)NOTE: laziness, for now
			HashTable.this.chain.valuesSet(offset, (V[])values.toArray(), valuesOffset, valuesLength);
			return this;
		}
