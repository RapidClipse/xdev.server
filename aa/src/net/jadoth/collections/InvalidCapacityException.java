...
public class InvalidCapacityException extends RuntimeException
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3044198586943920927L;
	...
	public InvalidCapacityException(final String message, final Throwable cause, final boolean enableSuppression, final boolean writableStackTrace)
	{
	...
	public InvalidCapacityException(final long maximumCapacity, final long desiredCapacity, final String message, final Throwable cause)
	{
		super(message, cause);
	...
	public InvalidCapacityException(final long maximumCapacity, final long desiredCapacity, final String message, final Throwable cause, final boolean enableSuppression, final boolean writableStackTrace)
	{
		super(message, cause, enableSuppression, writableStackTrace);
		this.maximumCapacity = maximumCapacity;
		this.desiredCapacity = desiredCapacity;
