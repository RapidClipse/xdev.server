...
//	}
	...
	@Override
	public final ListAccessor<E> fill(final int offset, final int length, final E element)
	{
...
//	{
//		return this.list.replaceAll(samples, equalator, newElement);
//	}
...
//	{
//		return this.list.replaceOne(sample, equalator, replacement);
//	}
...
//	}
	...
	@SafeVarargs
	@Override
	public final ListAccessor<E> setAll(final int offset, final E... elements)
	{
	...
	@Override
	public final ListAccessor<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
	...
	@Override
	public final ListAccessor<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
	...
	@Override
	public final XSettingList<E> range(final int fromIndex, final int toIndex)
	{
	...
	@Override
	public final ListAccessor<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
	...
	@Override
	public final ListAccessor<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
	...
	@Override
	public final ListAccessor<E> shiftBy(final int sourceIndex, final int distance)
	{
	...
	@Override
	public final ListAccessor<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
	...
	@Override
	public final ListAccessor<E> swap(final int indexA, final int indexB, final int length)
	{
	...
	@Override
	public final ListAccessor<E> swap(final int indexA, final int indexB)
	{
	...
	public static final class OldListAccessor<E> extends OldSettingList<E>
	{
