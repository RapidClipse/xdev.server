...
//	}
	...
	@Override
	public final LockedList<E> fill(final int offset, final int length, final E element)
	{
		synchronized(this.lock){
...
//	}
	...
	@Override
	public final LockedList<E> removeRange(final int startIndex, final int length)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> retainRange(final int startIndex, final int length)
	{
		synchronized(this.lock){
...
//	@Override
//	public final int replaceAll(final XGettingCollection<? extends E> samples, final Equalator<? super E> equalator, final E newElement)
//	{
//		synchronized(this.mutex){
...
//	}
	...
	@SafeVarargs
	@Override
	public final LockedList<E> setAll(final int offset, final E... elements)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
		synchronized(this.lock){
	...
	@Override
	public final XList<E> range(final int fromIndex, final int toIndex)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> swap(final int indexA, final int indexB, final int length)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> swap(final int indexA, final int indexB)
	{
		synchronized(this.lock){
	...
	@Override
	public final XGettingList<E> view(final int fromIndex, final int toIndex)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> shiftBy(final int sourceIndex, final int distance)
	{
		synchronized(this.lock){
	...
	@Override
	public final LockedList<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		synchronized(this.lock){
	...
	public static final class OldMutexList<E> extends BridgeXList<E>
	{
