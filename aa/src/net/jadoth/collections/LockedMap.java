...
public final class LockedMap<K, V> implements XMap<K, V>, Synchronized
{
	...
	@Override
	public final <P extends Procedure<? super KeyValue<K, V>>> P process(final P processor)
	{
		synchronized(this.lock){
	...
	@Override
	public final int remove(final KeyValue<K, V> element)
	{
		synchronized(this.lock){
	...
	@Override
	public final int count(final KeyValue<K, V> element)
	{
		synchronized(this.lock){
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T distinct(final T target)
	{
		synchronized(this.lock){
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T distinct(
		final T target,
		final Equalator<? super KeyValue<K, V>> equalator
	)
	{
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T copyTo(final T target)
	{
		synchronized(this.lock){
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T filterTo(
		final T target,
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T union(
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T intersect(
		final XGettingCollection<? extends KeyValue<K, V>> other,
		final Equalator<? super KeyValue<K, V>> equalator,
		final T target
	)
	...
	@Override
	public final <T extends Procedure<? super KeyValue<K, V>>> T except(
		final XGettingCollection<? extends KeyValue<K, V>> other,
		final Equalator<? super KeyValue<K, V>> equalator,
		final T target
	)
