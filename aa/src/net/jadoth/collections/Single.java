...
public class Single<E> implements XList<E>, XEnum<E>, XReference<E>
{
	...
	@Override
	public XReferencing<E> view(final int lowIndex, final int highIndex)
	{
...
//	}
	...
	@Override
	public Single<E> removeRange(final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XProcessingSequence<E>#removeRange()
	}

	@Override
	public Single<E> retainRange(final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XProcessingSequence<E>#removeRange()
	}
...
//	}
	...
	@SafeVarargs
	@Override
	public final Single<E> setAll(final int index, final E... elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#set()
	}

	@Override
	public Single<E> set(final int index, final E[] elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#set()
	}

	@Override
	public Single<E> set(final int index, final XGettingSequence<? extends E> elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#set()
	}

	@Override
	public Single<E> swap(final int indexA, final int indexB)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#swap()
	}

	@Override
	public Single<E> swap(final int indexA, final int indexB, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#swap()
	}
	...
	@Override
	public Single<E> range(final int fromIndex, final int toIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#range()
	}

	@Override
	public Single<E> fill(final int offset, final int length, final E element)
	{
	...
	@Override
	public Single<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#shiftTo()
	}

	@Override
	public Single<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#shiftTo()
	}

	@Override
	public Single<E> shiftBy(final int sourceIndex, final int distance)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#shiftBy()
	}

	@Override
	public Single<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME XList<E>#shiftBy()
	}
