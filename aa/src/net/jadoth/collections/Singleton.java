...
public class Singleton<E> implements XReference<E>
{
	...
	@Override
	public final Singleton<E> range(final int fromIndex, final int toIndex)
	{
		if(fromIndex != 0){
			throw new IndexOutOfBoundsException();
		}
	...
	@Override
	public final SingletonView<E> view(final int lowIndex, final int highIndex)
	{
		if(lowIndex != 0){
			throw new IndexOutOfBoundsException();
		}
...
//	}
	...
	@Override
	public final Singleton<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME Auto-generated method stub, not implemented yet
	}

	@Override
	public final Singleton<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME Auto-generated method stub, not implemented yet
	}

	@Override
	public final Singleton<E> shiftBy(final int sourceIndex, final int distance)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME Auto-generated method stub, not implemented yet
	}

	@Override
	public final Singleton<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public final Singleton<E> fill(final int offset, final int length, final E element)
	{
	...
	@SafeVarargs
	@Override
	public final Singleton<E> setAll(final int index, final E... elements)
	{
	...
	@Override
	public final Singleton<E> set(final int index, final E[] elements, final int offset, final int length)
	{
	...
	@Override
	public final Singleton<E> set(final int index, final XGettingSequence<? extends E> elements, final int offset, final int length)
	{
		if(index != 0 || offset != 0 || length != 1){
			throw new IndexOutOfBoundsException();
		}
	...
	@Override
	public final Singleton<E> swap(final int indexA, final int indexB)
	{
	...
	@Override
	public final Singleton<E> swap(final int indexA, final int indexB, final int length)
	{
		// sanity checks reducing this method to be a no-op, of course
	...
	final class OldSingleton implements OldList<E>, OldSet<E>
	{
		...
		{
			return Singleton.this.indexOf((E)o); // safe because of referencial comparison
		}
		...
		{
			return Singleton.this.lastIndexOf((E)o); // safe because of referencial comparison
		}
