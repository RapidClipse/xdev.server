...
//	}
	...
	@Override
	public synchronized <C extends Procedure<? super E>> C filterTo(final C target, final Predicate<? super E> predicate)
	{
	...
	@Override
	public synchronized <C extends Procedure<? super E>> C copyTo(final C target)
	{
...
//	}
	...
	@Override
	public synchronized int count(final E element)
	{
		return this.subject.count(element);
	}

	@Override
	public synchronized int countBy(final Predicate<? super E> predicate)
	{
		return this.subject.countBy(predicate);
	}

	@Override
	public synchronized <C extends Procedure<? super E>> C distinct(final C target, final Equalator<? super E> equalator)
	{
		return this.subject.distinct(target, equalator);
	}

	@Override
	public synchronized <C extends Procedure<? super E>> C distinct(final C target)
	{
	...
	@Override
	public synchronized <C extends Procedure<? super E>> C except(final XGettingCollection<? extends E> other, final Equalator<? super E> equalator, final C target)
	{
	...
	@Override
	public synchronized <P extends Procedure<? super E>> P iterate(final P procedure)
	{
	...
	@Override
	public synchronized <C extends Procedure<? super E>> C intersect(final XGettingCollection<? extends E> other, final Equalator<? super E> equalator, final C target)
	{
	...
	@Override
	public synchronized <C extends Procedure<? super E>> C moveTo(final C target, final Predicate<? super E> predicate)
	{
		return this.subject.moveTo(target, predicate);
	}

	@Override
	public synchronized final <P extends Procedure<? super E>> P process(final P procedure)
	{
	...
	@Override
	public synchronized int removeBy(final Predicate<? super E> predicate)
	{
...
//	}
	...
	@Override
	public synchronized int remove(final E element)
	{
...
//	}
	...
	@Override
	public synchronized int removeAll(final XGettingCollection<? extends E> elements)
	{
		return this.subject.removeAll(elements);
	}

	@Override
	public synchronized int removeDuplicates(final Equalator<? super E> equalator)
	{
		return this.subject.removeDuplicates(equalator);
	}

	@Override
	public synchronized int removeDuplicates()
	{
		return this.subject.removeDuplicates();
	}

	@Override
	public synchronized int nullRemove()
	{
...
//	}
	...
	@Override
	public synchronized int retainAll(final XGettingCollection<? extends E> elements)
	{
...
//	}
	...
	@Override
	public synchronized int optimize()
	{
	...
	@Override
	public synchronized <C extends Procedure<? super E>> C union(final XGettingCollection<? extends E> other, final Equalator<? super E> equalator, final C target)
	{
	...
	public static final class OldSynchSet<E> extends BridgeXSet<E>
	{
