...
public class X
{
	...
	{
		if(oldList instanceof BridgeXList<?>){
			return ((BridgeXList<E>)oldList).parent();
		}
	...
	{
		if(oldSet instanceof BridgeXSet<?>){
			return ((BridgeXSet<E>)oldSet).parent();
		}
...
//		return array; // do not rely on reference returned by the implementation but return local variable.
	...
	public static <E, C extends Procedure<? super E>> C collectNotNull(final C target, final E element)
	{
		if(element != null){
	...
	public static <E, C extends XAddingCollection<? super E>> C addNotNull(final C target, final XGettingCollection<E> elements)
	{
		if(elements != null){
	...
	public static <I, O, T extends Procedure<? super O>> T map(
	...
	)
	{
		...
		elements.iterate(new Procedure<I>(){
			@Override public void accept(final I e) {
	...
	public static final <K, V, C extends Procedure<? super V>>
	...
	public static final <E, R> Aggregator<E, R> aggregator(final BiProcedure<? super E, ? super R> joiner, final R aggregate)
	{
		return
			new Aggregator<E, R>()
			{
