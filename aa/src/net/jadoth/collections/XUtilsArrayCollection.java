...
public class XUtilsArrayCollection
{
...
//	}
	...
	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>,
	C extends Procedure<? super E>> C rngCopyTo(final A a, final int offset, final int length, final C target)
	{
		return AbstractArrayStorage.rngCopyTo(a.internalGetStorageArray(), Jadoth.to_int(a.size()), offset, length, target);
	}

	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>>
	A rngIterate(final A a, final int offset, final int length, final Procedure<? super E> procedure)
	{
	...
	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>>
	VarString rngAppendTo(final A a, final int offset, final int length, final VarString vc, final String seperator)
	{
		return AbstractArrayStorage.rngAppendTo(
			a.internalGetStorageArray(), Jadoth.to_int(a.size()), offset, length, vc, seperator
		);
	}

	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>>
	VarString rngAppendTo(final A a, final int offset, final int length, final VarString vc, final char seperator)
	{
		return AbstractArrayStorage.rngAppendTo(
			a.internalGetStorageArray(), Jadoth.to_int(a.size()), offset, length, vc, seperator
		);
	...
	{
		return AbstractArrayStorage.rngAppendTo(
			a.internalGetStorageArray(), Jadoth.to_int(a.size()), offset, length, vc, appender, seperator
		);
	}
	...
	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>, C extends Procedure<? super E>>
