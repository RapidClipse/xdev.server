...
public final class _intList implements _intCollecting, Composition
{
	...
	protected int internalCountingAddAll(final int[] elements, final int offset, final int length) throws UnsupportedOperationException
	{
		if(length >= 0){
	...
	protected int internalCountingPutAll(final int[] elements, final int offset, final int length) throws UnsupportedOperationException
	{
		if(length >= 0){
			this.ensureFreeCapacity(length); // increaseCapacity
			System.arraycopy(elements, offset, this.data, this.size, length); // automatic bounds checks
...
//	}
	...
	{
		_intArrayStorage.iterate(this.data, this.size, procedure);
		return this;
	}
	...
	{
		return _intArrayStorage.count(this.data, this.size, element);
	}

	public int count(final _intPredicate predicate)
	{
		return _intArrayStorage.count(this.data, this.size, predicate);
	}
	...
	{
		return _intArrayStorage.indexOf(this.data, this.size, element);
	}

	public int indexOf(final _intPredicate predicate)
	{
		return _intArrayStorage.indexOf(this.data, this.size, predicate);
	}

	public int lastIndexOf(final int element)
	{
		return _intArrayStorage.rngIndexOF(this.data, this.size, this.size - 1, -this.size, element);
	}

	public int lastIndexOf(final _intPredicate predicate)
	{
		return _intArrayStorage.lastIndexOf(this.data, this.size, predicate);
	}

	public int scan(final _intPredicate predicate)
	{
		return _intArrayStorage.scan(this.data, this.size, predicate);
	}
	...
	{
		return _intArrayStorage.search(this.data, this.size, predicate);
	}

	public int max()
	{
		return _intArrayStorage.max(this.data, this.size);
	}

	public int min()
	{
		return _intArrayStorage.min(this.data, this.size);
	}
	...
	{
		return _intArrayStorage.isSorted(this.data, this.size, ascending);
	}
	...
	{
		return _intArrayStorage.applies(this.data, this.size, predicate);
	}

	public boolean applies(final _intPredicate predicate)
	{
		return _intArrayStorage.appliesAll(this.data, this.size, predicate);
	}
	...
	{
		return _intArrayStorage.contains(this.data, this.size, element);
	}

	public boolean containsAll(final _intList elements)
	{
		return _intArrayStorage.containsAll(this.data, this.size, elements.data, 0, elements.size);
	}
	...
	{
		return _intArrayStorage.copyTo(this.data, this.size, target);
	}

	public _intCollecting copyTo(final _intCollecting target, final _intPredicate predicate)
	{
		return _intArrayStorage.copyTo(this.data, this.size, target, predicate);
	}
	...
	{
		return _intArrayStorage.rngCopyTo(this.data, this.size, offset, length, target, targetOffset);
	}

	public _intCollecting copySelection(final _intCollecting target, final int... indices)
	{
		return _intArrayStorage.copySelection(this.data, this.size, indices, target);
	}
...
//	}
	...
	{
		_intArrayStorage.swap(this.data, this.size, indexA, indexB, length);
		return this;
	}

	public _intList reverse()
	{
		_intArrayStorage.reverse(this.data, this.size);
		return this;
	}
	...
	{
		_intArrayStorage.set(this.data, this.size, offset, src, srcIndex, srcLength);
		return this;
	}

	public _intList fill(final int offset, final int length, final int element)
	{
		_intArrayStorage.fill(this.data, this.size, offset, length, element);
		return this;
	}
	...
	{
		return _intArrayStorage.replaceOne(this.data, this.size, element, replacement);
	}

	public boolean replaceOne(final _intPredicate predicate, final int substitute)
	{
		return _intArrayStorage.substituteOne(this.data, this.size, predicate, substitute);
	}
	...
	{
		return _intArrayStorage.replace(this.data, this.size, element, replacement);
	}

	public int replace(final _intPredicate predicate, final int substitute)
	{
		return _intArrayStorage.substitute(this.data, this.size, predicate, substitute);
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME _intList#replaceAll()
	}
	...
	{
		return _intArrayStorage.modify(this.data, this.size, mapper);
	}

	public int modify(final _intPredicate predicate, final _intFunction mapper)
	{
		return _intArrayStorage.modify(this.data, this.size, predicate, mapper);
	}
	...
	{
		if(_intArrayStorage.removeOne(this.data, this.size, element)){
			this.size--;
			return true;
		}
		return false;
	...
	{
		final Integer removedElement;
		if((removedElement = _intArrayStorage.retrieve(this.data, this.size, element, Integer.MIN_VALUE)) != null){
			this.size--;
	...
	{
		final Integer e;
		if((e = _intArrayStorage.retrieve(this.data, this.size, predicate, Integer.MIN_VALUE)) != null){
			this.size--;
			return e;
		}
		return 0;
	...
	public int remove(final _intPredicate predicate)
	{
		...
		this.size -= removeCount = _intArrayStorage.reduce(this.data, this.size, predicate, Integer.MIN_VALUE);
		return removeCount;
	}
	...
	{
		this.size -= _intArrayStorage.process(this.data, this.size, procedure, Integer.MIN_VALUE);
		return this;
	}
	...
	{
		this.size -= _intArrayStorage.moveTo(this.data, this.size, target, predicate, Integer.MIN_VALUE);
		return target;
	}

	public _intCollecting moveSelection(final _intCollecting target, final int... indices)
	{
		this.size -= _intArrayStorage.moveSelection(this.data, this.size, indices, target, Integer.MIN_VALUE);
		return target;
	}
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME _intList#removeAll()
//		final int removed;
...
//		return removed;
	...
	{
		final int removeCount;
		this.size -= removeCount = _intArrayStorage.removeDuplicates(this.data, this.size, Integer.MIN_VALUE);
		return removeCount;
	}
	...
	{
		final int removeCount;
		this.size -= removeCount = _intArrayStorage.removeSelection(this.data, this.size, indices, Integer.MIN_VALUE);
		return removeCount;
	}

	public _intList removeRange(final int startIndex, final int length)
	{
		this.size -= _intArrayStorage.removeRange(this.data, this.size, startIndex, length);
		return this;
	}
...
//	}
	...
	{
		return _intArrayStorage.toString(this.data, this.size);
	}
