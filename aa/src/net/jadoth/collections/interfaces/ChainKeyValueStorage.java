...
extends ChainStorage<KeyValue<K, V>, K, V, EN>
{
	...
	public <C extends Procedure<? super K>> C keyIntersect(
		XGettingCollection<? extends K> collection,
		Equalator<? super K> equalator,
		C target
	);

	public <C extends Procedure<? super K>> C keyExcept(
		XGettingCollection<? extends K> collection,
		Equalator<? super K> equalator,
		C target
	);

	public <C extends Procedure<? super K>> C keyUnion(
		XGettingCollection<? extends K> collection,
		Equalator<? super K> equalator,
		C target
	);

	public <C extends Procedure<? super K>> C keyRngIntersect(
		int offset,
		int length,
		XGettingCollection<? extends K> collection,
		Equalator<? super K> equalator,
	...
	public <C extends Procedure<? super K>> C keyRngExcept(
		int offset,
		int length,
		XGettingCollection<? extends K> collection,
		Equalator<? super K> equalator,
	...
	public <C extends Procedure<? super K>> C keyRngUnion(
		int offset,
		int length,
		XGettingCollection<? extends K> collection,
		Equalator<? super K> equalator,
	...
	public <C extends Procedure<? super K>> C keyCopyTo(C target);

	public <C extends Procedure<? super K>> C keyRngCopyTo(int offset, int length, C target);

	public <C extends Procedure<? super K>> C keyCopySelection(C target, int... indices);

	public int keyCopyToArray(int offset, int length, Object[] target, int targetOffset);

	public <C extends Procedure<? super K>> C keyCopyTo(C target,Predicate<? super K> predicate);

	public <C extends Procedure<? super K>> C keyRngCopyTo(
		int offset,
		int length,
		C target,
	...
	public void keyIterate(Procedure<? super K> procedure);
	
	public <A> void keyJoin(BiProcedure<? super K, A> joiner, A keyAggregate);

	public void keyRngIterate(int offset, int length, Procedure<? super K> procedure);
	...
	public void keyIterate(Predicate<? super K> predicate, Procedure<? super K> procedure);
	...
	public <C extends Procedure<? super K>> C keyDistinct(C target);

	public <C extends Procedure<? super K>> C keyDistinct(C target, Equalator<? super K> equalator);

	public <C extends Procedure<? super K>> C keyRngDistinct(int offset, int length, C target);

	public <C extends Procedure<? super K>> C keyRngDistinct(
		int offset,
		int length,
		C target,
		Equalator<? super K> equalator
	...
	public VarString keyAppendTo(VarString vc, char seperator);

	public VarString keyAppendTo(VarString vc, String seperator);

	public VarString keyAppendTo(VarString vc, BiProcedure<VarString, ? super K> keyAppender);

	public VarString keyAppendTo(VarString vc, BiProcedure<VarString, ? super K> keyAppender, char seperator);

	public VarString keyAppendTo(VarString vc, BiProcedure<VarString, ? super K> keyAppender, String seperator);

	public VarString keyRngAppendTo(int offset, int length, VarString vc);

	public VarString keyRngAppendTo(int offset, int length, VarString vc, char seperator);

	public VarString keyRngAppendTo(int offset, int length, VarString vc, String seperator);

	public VarString keyRngAppendTo(int offset, int length, VarString vc, BiProcedure<VarString, ? super K> keyAppender);

	public VarString keyRngAppendTo(int offset, int length, VarString vc, BiProcedure<VarString, ? super K> keyAppender, char seperator);

	public VarString keyRngAppendTo(int offset, int length, VarString vc, BiProcedure<VarString, ? super K> keyAppender, String seperator);
	...
	public K keyRemove(final int index);

	public int keyRemoveNull();

	public int keyRngRemoveNull(int offset, int length);

	public K keyRetrieve(K element);

	public K keyRetrieve(Predicate<? super K> predicate);

	public K keyRngRetrieve(int offset, int length, K element);
	...
	public int keyProcess(Procedure<? super K> procedure);

	public int keyRngProcess(int offset, int length, Procedure<? super K> procedure);
	...
	public int keyMoveRange(int offset, int length, Procedure<? super K> target);

	public int keyMoveSelection(Procedure<? super K> target, int... indices);

	public int keyMoveTo(Procedure<? super K> target, Predicate<? super K> predicate);

	public int keyRngMoveTo(int offset, int length, Procedure<? super K> target, Predicate<? super K> predicate);
	...
	public ListIterator<V> valuesListIterator(int index);
	...
	public boolean valuesRngContainsId(int offset, int length, V valuesue);
	...
	public boolean valuesRngContains(int offset, int length, V valuesue);
	...
	public int valuesRngCount(int offset, int length, V valuesue);
	...
	public <C extends Procedure<? super V>> C valuesIntersect(
		XGettingCollection<? extends V> collection,
		Equalator<? super V> equalator,
		C target
	);

	public <C extends Procedure<? super V>> C valuesExcept(
		XGettingCollection<? extends V> collection,
		Equalator<? super V> equalator,
		C target
	);

	public <C extends Procedure<? super V>> C valuesUnion(
		XGettingCollection<? extends V> collection,
		Equalator<? super V> equalator,
		C target
	);

	public <C extends Procedure<? super V>> C valuesRngIntersect(
		int offset,
		int length,
		XGettingCollection<? extends V> collection,
		Equalator<? super V> equalator,
	...
	public <C extends Procedure<? super V>> C valuesRngExcept(
		int offset,
		int length,
		XGettingCollection<? extends V> collection,
		Equalator<? super V> equalator,
	...
	public <C extends Procedure<? super V>> C valuesRngUnion(
		int offset,
		int length,
		XGettingCollection<? extends V> collection,
		Equalator<? super V> equalator,
	...
	public <C extends Procedure<? super V>> C valuesCopyTo(C target);

	public <C extends Procedure<? super V>> C valuesRngCopyTo(int offset, int length, C target);

	public <C extends Procedure<? super V>> C valuesCopySelection(C target, int... indices);

	public int valuesCopyToArray(int offset, int length, Object[] target, int targetOffset);

	// data - conditional copying //

	public <C extends Procedure<? super V>> C valuesCopyTo(C target,Predicate<? super V> predicate);

	public <C extends Procedure<? super V>> C valuesRngCopyTo(
		int offset,
		int length,
		C target,
	...
	public void valuesIterate(Procedure<? super V> procedure);

	public void valuesRngIterate(int offset, int length, Procedure<? super V> procedure);
	...
	public void valuesIterate(Predicate<? super V> predicate, Procedure<? super V> procedure);
	...
	public int valuesRngIndexOf(int offset, int length, V valuesue);
	...
	public <C extends Procedure<? super V>> C valuesDistinct(C target);

	public <C extends Procedure<? super V>> C valuesDistinct(C target, Equalator<? super V> equalator);

	public <C extends Procedure<? super V>> C valuesRngDistinct(int offset, int length, C target);

	public <C extends Procedure<? super V>> C valuesRngDistinct(
		int offset,
		int length,
		C target,
		Equalator<? super V> equalator
	...
	public VarString valuesAppendTo(VarString vc, char seperator);

	public VarString valuesAppendTo(VarString vc, String seperator);

	public VarString valuesAppendTo(VarString vc, BiProcedure<VarString, ? super V> appender);

	public VarString valuesAppendTo(VarString vc, BiProcedure<VarString, ? super V> appender, char seperator);

	public VarString valuesAppendTo(VarString vc, BiProcedure<VarString, ? super V> appender, String seperator);

	public VarString valuesRngAppendTo(int offset, int length, VarString vc);

	public VarString valuesRngAppendTo(int offset, int length, VarString vc, char seperator);

	public VarString valuesRngAppendTo(int offset, int length, VarString vc, String seperator);

	public VarString valuesRngAppendTo(int offset, int length, VarString vc, BiProcedure<VarString, ? super V> appender);

	public VarString valuesRngAppendTo(int offset, int length, VarString vc, BiProcedure<VarString, ? super V> appender, char seperator);

	public VarString valuesRngAppendTo(int offset, int length, VarString vc, BiProcedure<VarString, ? super V> appender, String seperator);
	...
	public V valuesRemove(final int index);
	...
	public V valuesRngRetrieve(int offset, int length, V valuesue);
	...
	public boolean valuesRngRemoveOne(int offset, int length, V valuesue);
	...
	public int valuesRngRemove(int offset, int length, V valuesue);
	...
	public int valuesProcess(Procedure<? super V> procedure);

	public int valuesRngProcess(int offset, int length, Procedure<? super V> procedure);
	...
	public int valuesMoveRange(int offset, int length, Procedure<? super V> target);

	public int valuesMoveSelection(Procedure<? super V> target, int... indices);

	// moving - conditional //

	public int valuesMoveTo(Procedure<? super V> target, Predicate<? super V> predicate);

	public int valuesRngMoveTo(int offset, int length, Procedure<? super V> target, Predicate<? super V> predicate);
	...
	public V valuesSet(int offset, V valuesue);

	public void valuesSet(int offset, V[] values);

	public void valuesSet(int offset, V[] values, int valuesOffset, int valuesLength);

	public void valuesFill(int offset, int length, V valuesue);
	...
	public int valuesRngReplaceOne(int offset, int length, V valuesue, V replacement);
	...
	public int valuesRngReplace(int offset, int length, V valuesue, V replacement);
