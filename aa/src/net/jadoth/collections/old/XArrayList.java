...
public class XArrayList<E> extends AbstractSimpleArrayCollection<E> implements XList<E>
{
	...
	{
		this.subject.add(index, element);
		return true;
	}

	@SuppressWarnings("unchecked")
	@Override
	public int insertAll(final int index, final E... elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public int insertAll(final int index, final E[] elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public int insertAll(final int index, final XGettingCollection<? extends E> elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public boolean nullInsert(final int index)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public boolean input(final int index, final E element)
	{
		this.subject.add(index, element);
		return true;
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public int inputAll(final int index, final E... elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public int inputAll(final int index, final E[] elements, final int offset, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public int inputAll(final int index, final XGettingCollection<? extends E> elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public boolean nullInput(final int index)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public SubList<E> range(final int fromIndex, final int toIndex)
	{
...
//	}
	...
	@Override
	public <T extends Procedure<? super E>> T copyTo(final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public <T extends Procedure<? super E>> T filterTo(final T target, final Predicate<? super E> predicate)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
...
//	}
	...
	@Override
	public <T extends Procedure<? super E>> T distinct(final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public <T extends Procedure<? super E>> T distinct(final T target, final Equalator<? super E> equalator)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public <T extends Procedure<? super E>> T except(final XGettingCollection<? extends E> other, final Equalator<? super E> equalator, final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public <T extends Procedure<? super E>> T intersect(final XGettingCollection<? extends E> other, final Equalator<? super E> equalator, final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
...
//	}
	...
	{
		return AbstractArrayStorage.containsSame(this.internalGetStorageArray(), this.subject.size(), sample) ?sample :null;
	}
	...
	@Override
	public <T extends Procedure<? super E>> T union(final XGettingCollection<? extends E> other, final Equalator<? super E> equalator, final T target)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
...
//	}
	...
	@Override
	public <T extends Procedure<? super E>> T copySelection(final T target, final int... indices)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
...
//	}
	...
	{
		return this.subject.remove(index);
	}
...
//	}
	...
	@Override
	public XArrayList<E> removeRange(final int startIndex, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> retainRange(final int startIndex, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public XArrayList<E> fill(final int offset, final int length, final E element)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
...
//	}
	...
	{
		this.subject.set(index, element);
		return false;
	}

	@Override
	public E setGet(final int index, final E element)
	{
	...
	@SuppressWarnings("unchecked")
	@Override
	public XArrayList<E> setAll(final int offset, final E... elements)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> set(final int offset, final E[] src, final int srcIndex, final int srcLength)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> set(final int offset, final XGettingSequence<? extends E> elements, final int elementsOffset, final int elementsLength)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}
	...
	@Override
	public XArrayList<E> shiftTo(final int sourceIndex, final int targetIndex)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> shiftTo(final int sourceIndex, final int targetIndex, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> shiftBy(final int sourceIndex, final int distance)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> shiftBy(final int sourceIndex, final int distance, final int length)
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIX-ME Auto-generated method stub, not implemented yet
	}

	@Override
	public XArrayList<E> swap(final int indexA, final int indexB)
	{
		AbstractArrayStorage.swap(this.internalGetStorageArray(), this.subject.size(), indexA, indexB);
		return this;
	}

	@Override
	public XArrayList<E> swap(final int indexA, final int indexB, final int length)
	{
		AbstractArrayStorage.swap(this.internalGetStorageArray(), this.subject.size(), indexA, indexB, length);
		return this;
	}
	 ...
	 */
	public static final class OldArrayList<E> extends BridgeXList<E>
	{
