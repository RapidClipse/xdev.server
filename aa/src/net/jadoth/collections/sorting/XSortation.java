...
import net.jadoth.collections.types.XBasicSequence;
...
{
	public interface Factory<E> extends XBasicSequence.Factory<E>, XPutGetSortation.Factory<E>, XProcessingSortation.Factory<E>
	{
		@Override
