...
import net.jadoth.collections.sorting.XSortation;

/**
 * Intermediate sequence type providing getting, adding, removing concearns to act as a common super type for
 * {@link XSequence} and {@link XSortation}. This is necessary because {@link XSortation} cannot provide
 * the otherwise typical sequence concearns like inserting and ordering due to the limitations of the characteristic
