...
public interface XIncreasingEnum<E> extends XInputtingEnum<E>, XSortableEnum<E>, XIncreasingSequence<E>
{
	...
	@Override
	public XIncreasingEnum<E> swap(int indexA, int indexB);

	@Override
	public XIncreasingEnum<E> swap(int indexA, int indexB, int length);
	...
	@Override
	public XIncreasingEnum<E> range(int fromIndex, int toIndex);
