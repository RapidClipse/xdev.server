...
public class ThreadedInstantiating<E> extends Threaded<E>
{
	 ...
	 * {@link #ThreadLocalInstantiating(Instantiator)}) if at some point the optimizing algorithm detects that a smaller
	 ...
	 * @throws NullPointerException if the passed {@link Instantiator} instance is {@code null}.
	 */
	public ThreadedInstantiating(final Instantiator<E> instantiator, final int initialCapacity) throws NullPointerException
	{
	...
	/**
	 * Returns the wrapped {@link Instantiator} instance used by this instance to create instances of type E to be associated
	 * with the current {@link Thread} if no association could have been found for it.
	 *
	 ...
	 * @see net.jadoth.concurrent.Threaded#lookupMissFallbackElement()
	 * @see net.jadoth.concurrent.Threaded#get()
	 */
	@Override
	protected E lookupMissFallbackElement()
	{
		...
		synchronized(this.instantiator){ // lock on instantiator instead of "this" to not prolong structural lock time
