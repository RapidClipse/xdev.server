...
public class ConfigEntryAggregator implements CsvRowCollector
{
	///////////////////////////////////////////////////////////////////////////
	// class methods  //
	///////////////////
	...
	private EqHashTable<String, String>           config      = null;
	...
	{
		this.completeConfig(); // letzte eingelesene datei abschlieﬂen
		return this.configs;
	}
