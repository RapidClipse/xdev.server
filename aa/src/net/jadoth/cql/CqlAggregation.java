...
public interface CqlAggregation<I, R> extends CqlQuery<I, I, R>
{
	...
	@Override
	public default CqlAggregation<I, R> skip(final Number count) // must be Number to allow fluent API use of int constant values
	{
	...
	@Override
	public default CqlAggregation<I, R> limit(final Number count) // must be Number to allow fluent API use of int constant values
	{
		return CqlAggregation.New(
			this.getSource()   ,
			this.getSkip()     ,
	...
	@Override
	public default <P extends Procedure<I> & XIterable<I>> CqlTransfer<I, P> into(final P target)
	{
