...
public interface CqlIteration<I, O, R extends XIterable<O>> extends CqlQuery<I, O, R>, XIterable<O>
{
	...
	@Override
	public default CqlIteration<I, O, R> skip(final Number count) // must be Number to allow fluent API use of int constant values
	{
	...
	@Override
	public default CqlIteration<I, O, R> limit(final Number count) // must be Number to allow fluent API use of int constant values
	{
		return CqlIteration.New(
			this.getSource()   ,
			this.getSkip()     ,
	...
	@Override
	public default <P extends Procedure<? super O>> P iterate(final P procedure)
	{
