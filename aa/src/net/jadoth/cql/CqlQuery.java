...
public interface CqlQuery<I, O, R>
{
	...
	public default CqlQuery<I, O, R> skip(final Number count) // must be Number to allow fluent API use of int constant values
	{
		return CqlQuery.New(
			this.getSource()   ,
			CQL.asLong(count) ,
	...
	public default CqlQuery<I, O, R> limit(final Number count) // must be Number to allow fluent API use of int constant values
	{
		return CqlQuery.New(
			this.getSource()   ,
			this.getSkip()     ,
	...
	public default <P extends Procedure<O> & XIterable<O>> CqlIteration<I, O, P> into(final Supplier<P> supplier)
	{
	...
	public default <P extends Procedure<O> & XIterable<O>> CqlIteration<I, O, P> into(final P target)
	{
		return CqlIteration.New(
			this.getSource()    ,
			this.getSkip()      ,
	...
	public default <P extends Procedure<O>> P executeInto(final P target)
	{
	...
	public default <P extends Procedure<I>> P executeSelection(
	...
	public default <P extends Procedure<O>> P executeInto(
		final XIterable<? extends I> source,
		final P                      target
	)
	{
		return CQL.executeQuery(source, getSkip(), getLimit(), getSelector(), getProjector(), target, getOrder());
	}
	...
	public static <I, O, R extends Procedure<O> & XIterable<O>> CqlQuery<I, O, R> New(
		final XIterable<? extends I> source    ,
		final Long                   skip      ,
		final Long                   limit     ,
		final Predicate<? super I>   selector  ,
