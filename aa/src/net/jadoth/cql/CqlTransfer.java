...
public interface CqlTransfer<I, R extends XIterable<I>> extends CqlIteration<I, I, R>
{
	...
	@Override
	public default <P extends Procedure<? super I>> P iterate(final P procedure)
	{
	...
	@Override
	public default <P extends Procedure<I>>P executeInto(final XIterable<? extends I> source, final P target)
	{
	...
	public static <I, T extends Procedure<I> & XIterable<I>> CqlTransfer<I, T> New(
		final XIterable<? extends I> source  ,
		final Long                   skip    ,
		final Long                   limit   ,
		final Predicate<? super I>   selector,
