...
public final class CSV
{
	...
	static final char             DEFAULT_SEPERATOR                   = '\t'; // the most reasonable control character for anyone who actually understands how it really works
	...
	{
		rows.iterate(new Procedure<T>() {
			@Override public void accept(final T entity) {
				rowAssembler.accept(entity, assembler);
				assembler.completeRow();
			}
		});
	...
	private CSV() { throw new UnsupportedOperationException(); } // enforce static only
}
