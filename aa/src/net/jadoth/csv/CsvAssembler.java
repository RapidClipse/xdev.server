...
public interface CsvAssembler
{
	...
	public interface Builder<O>
	{
		...
		public Builder<O> setValueSeperatorPrefix(String seperatorPrefix);

		public Builder<O> setValueSeperatorSuffix(String seperatorSuffix);

		public Builder<O> setRecordSeperatorPrefix(String seperatorPrefix);

		public Builder<O> setRecordSeperatorSuffix(String seperatorSuffix);
		...
		public final class Implementation implements Builder<VarString>
		{
			...
			@Override
			public final Builder<VarString> setValueSeperatorPrefix(final String seperatorPrefix)
			{
				this.valueSeparatorPrefix = notNull(seperatorPrefix);
				return this;
			}

			@Override
			public final Builder<VarString> setValueSeperatorSuffix(final String seperatorSuffix)
			{
				this.valueSeparatorSuffix = notNull(seperatorSuffix);
				return this;
			}


			@Override
			public final Builder<VarString> setRecordSeperatorPrefix(final String seperatorPrefix)
			{
				this.recordSeparatorPrefix = notNull(seperatorPrefix);
				return this;
			}

			@Override
			public final Builder<VarString> setRecordSeperatorSuffix(final String seperatorSuffix)
			{
				this.recordSeparatorSuffix = notNull(seperatorSuffix);
				return this;
			}
