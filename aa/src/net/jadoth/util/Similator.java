 ...
 * e.g. for integrating String similarity heuristics (like <code>if(similarName.evaluate("Jack", "Jake") > 0.5) {...}</code>}.
 * <p>
...
public interface Similator<T>
{
	...
	public final class Sequence<T> implements Similator<T>
	{
		...
		public double evaluate(final T o1, final T o2)
		{
			...
			for(int i = 0; i < this.similators.length; i++){ // spare foreach's unnecessary local variable
