...
class CsvTestPerson
{
	...
	static final SimpleDateFormat DATE_FORMAT_DOB_CSV = new SimpleDateFormat("yyyy-MM-dd");

	public static final CsvRowAssembler<CsvTestPerson> toCsvRow =
		new CsvRowAssembler<CsvTestPerson>()
		{
			@Override
			public void accept(final CsvTestPerson person, final CsvAssembler rowAssembler)
			{
...
//	;
	...
	public static void main(final String[] args)
	{
		...
		;
		CSV.assembleRow(csvAssembler, CsvRowAssembler.delimitedString,
