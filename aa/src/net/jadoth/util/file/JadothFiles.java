 ...
 *
 */
public abstract class JadothFiles
{
	...
	public static final char[] readCharsFromFile(final File file, final Procedure<? super IOException> exceptionHandler)
	{
	...
	public static final char[] readCharsFromFile(
		...
		final Procedure<? super IOException> exceptionHandler
	)
	{
		// sadly the geniuses wrapped generic char[] operations inside the String value type class, so it must be hacked
	...
	public static final void writeStringToFile(final File file, final String string, final Charset charset) throws IOException
	{
	...
	public static final FileChannel createWritingFileChannel(final File file, final boolean append) throws FileException, IOException
	{
