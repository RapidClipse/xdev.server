...
public class ThreadedPool<E> implements Pool<E>
{
	...
	private final Procedure<E> repooler = this::repool;
...
//		);
	 ...
	 */
	static class PoolCleaner<E> extends WeakReference<ThreadedPool<E>> implements Procedure<HashEnum<E>>
	{
	...
	static class PoolManager<E> extends Thread implements Immutable
	{
		...
		private final Procedure<? super E>           poolCloser;
		...
		{
			super();
			if(poolCheckInterval < 100)
			{
				throw new IllegalArgumentException(); // anything below 100 ms loop time is not reasonable
			}
