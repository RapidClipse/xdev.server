...
public final class CompositeItem implements Item, Serializable
{
	 ...
	 * List of item keys.
	 */
	private final List<String>		itemKeys			= new ArrayList<String>();
	/**
	 * Map of items.
	 */
	...
	{
		final List<Object> itemPropertyIds = new ArrayList<Object>();
		for(final String itemKey : this.itemKeys)
		{
			final Item item = this.items.get(itemKey);
	 ...
	 *
	 * @param id
	 *            ID of the property to be added.
	 * @param property
