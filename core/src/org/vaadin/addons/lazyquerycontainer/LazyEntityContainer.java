...
/**
 * LazyEntityContainer enables using JPA entities with lazy batch loading,
 * filter, sort and buffered writes.
 *
 * @param <T>
 *            Entity class.
...
public final class LazyEntityContainer<T> extends LazyQueryContainer
{
	 ...
	 */
	public LazyEntityContainer(final EntityManager entityManager, final Class<?> entityClass,
			final int batchSize, final Object idPropertyId,
			...
			final boolean compositeItems)
	{
		super(new EntityQueryDefinition(applicationManagedTransactions,detachedEntities,
				compositeItems,entityClass,batchSize,idPropertyId),
	...
	public LazyEntityContainer(final EntityManager entityManager,
			final boolean applicationManagedTransactions, final boolean detachedEntities,
			final boolean compositeItems, final Class<?> entityClass, final int batchSize,
