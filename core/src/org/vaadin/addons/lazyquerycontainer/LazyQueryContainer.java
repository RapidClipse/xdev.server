...
public class LazyQueryContainer implements Indexed, Sortable, ItemSetChangeNotifier,
		PropertySetChangeNotifier, Buffered, Container.Filterable, Serializable
{
	 ...
	 */
	public LazyQueryContainer(final QueryFactory queryFactory, final Object idPropertyId,
	 ...
	 */
	public LazyQueryContainer(final QueryDefinition queryDefinition,
	...
	public final Item getItem(final Object itemId)
	{
		...
		{
			final int index = this.queryView.getItemIdList().indexOf(itemId);
			if(index == -1)
			{
				return null;
			}
