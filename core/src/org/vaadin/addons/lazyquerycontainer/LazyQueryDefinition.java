...
/**
 * Default implementation of Query Definition. Contains the property, filtering
 * and sorting information of query.
 *
...
public class LazyQueryDefinition implements QueryDefinition, Serializable
{
	 ...
	 * @param idPropertyId
	 *            The ID of the ID property or null if item index in result set is
	 *            used as ID.
	 */
	...
	public final Collection<Object> getSortablePropertyIds()
	{
		...
		for(final Object propertyId : this.propertyIds)
		{
	...
	{
		return (Class<?>)this.propertyTypes.get(propertyId);
	}
	...
	{
		return this.readOnlyStates.get(propertyId);
	}
	...
	{
		return this.sortableStates.get(propertyId);
	}
	 ...
	 * @param sortable
	 *            True if property is sortable.
	 */
	@Override
	public final void addProperty(final Object propertyId, final Class<?> type,
			final Object defaultValue, final boolean readOnly, final boolean sortable)
	{
		...
		this.defaultValues.put(propertyId,defaultValue);
		this.readOnlyStates.put(propertyId,readOnly);
		this.sortableStates.put(propertyId,sortable);
	}
	...
	public final void removeProperty(final Object propertyId)
	{
		...
		this.propertyTypes.remove(propertyId);
		this.defaultValues.remove(propertyId);
		this.readOnlyStates.remove(propertyId);
		this.sortableStates.remove(propertyId);
	}
	...
	/**
	 * Gets the ID of the ID property or null if item index in result set is used as
	 * ID.
	 * 
	 * @return The ID of the ID property or null if item index in result set is used
	 *         as ID.
	 */
	@Override
	...
	/**
	 * Set the ID of the ID property or null if item index in result set is used as
	 * ID.
	 * 
	 * @param idPropertyId
	 *            The ID of the ID property or null if item index in result set is
	 ...
	 *            the default sort property ascending states.
	 */
	@Override
	public final void setDefaultSortPropertyAscendingStates(
			final boolean[] defaultSortPropertyAscendingStates)
	{
	 ...
	 */
	@Override
	public final void setDefaultSortState(final Object[] sortPropertyIds,
	...
	{
		return this.maxNestedPropertyDepth;
	}
