...
public interface QueryDefinition
{
	 ...
	 */
	void addProperty(Object propertyId, Class<?> type, Object defaultValue, boolean readOnly,
			boolean sortable);
	...
	/**
	 * Sets the query batch size. After this method has been called the Query has to
	...
	/**
	 * Sets whether query wraps items to CompositeItems. After this method has been
	 * called the Query has to be discarded immediately.
	 *
	 ...
	 */
	void setDefaultSortState(final Object[] sortPropertyIds,
