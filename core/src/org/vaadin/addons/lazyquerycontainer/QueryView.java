...
public interface QueryView
{
	 ...
	 *            List of sort order for the properties.
	 */
	void sort(Object[] sortPropertyIds, boolean[] ascendingStates);
	
	
	/**
	 * Refreshes data from business service and notifies listeners of changed item
	 * set.
	 */
	void refresh();
	...
	/**
	 * Saves changes. Refresh has to be invoked after this method to clear the
	 * cache.
	 */
	void commit();
	...
	/**
	 * Cancels changes. Refresh has to be invoked after this method to clear the
	 * cache.
	 */
	void discard();
