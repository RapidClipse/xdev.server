...
public class TableExportWizard extends XdevGridLayout
{
	...
	private void initUI()
	{
		...
		this.setIcon(FontAwesome.TABLE);
		this.setCaption(StringResourceUtils.localizeString("{$caption}",this));
		...
		this.lblStatus.setValue(StringResourceUtils.localizeString("{$widthToBigError}",this));
		...
		this.addComponent(this.txtReportName,0,0);
		this.tblColumnChooser.setWidth(100,Unit.PERCENTAGE);
		this.tblColumnChooser.setHeight(300,Unit.PIXELS);
		this.addComponent(this.tblColumnChooser,0,1);
		this.layoutTableButtons.setSizeUndefined();
		this.addComponent(this.layoutTableButtons,1,1);
		this.layoutSettings.setSizeUndefined();
		this.addComponent(this.layoutSettings,0,2);
		this.footer.setWidth(100,Unit.PERCENTAGE);
		this.footer.setHeight(-1,Unit.PIXELS);
		this.addComponent(this.footer,0,3,1,3);
		this.setComponentAlignment(this.footer,Alignment.MIDDLE_RIGHT);
		this.setColumnExpandRatio(0,10.0F);
		...
		this.cbPageType.addValueChangeListener(new Property.ValueChangeListener()
		{
			...
			{
				TableExportWizard.this.cbPageType_valueChange(event);
			}
		});
		this.cbPageOrientation.addValueChangeListener(new Property.ValueChangeListener()
		{
			...
			public void valueChange(final Property.ValueChangeEvent event)
			{
				TableExportWizard.this.cbPageOrientation_valueChange(event);
			}
		});
