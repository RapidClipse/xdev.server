...
package com.xdev.ui.persistence.gson;
...
import com.xdev.ui.persistence.GuiPersistentStates;
 ...
 *
 */
public interface GuiPersistenceGson
{
	public final static GuiPersistenceGson DEFAULT = new Implementation();


	public String serialize(final GuiPersistentStates states);
	
	
	public GuiPersistentStates deserialize(final String json) throws JsonParseException;



	public static class Implementation implements GuiPersistenceGson
	{
		@Override
		public String serialize(final GuiPersistentStates states)
		{
		...
		public GuiPersistentStates deserialize(final String json) throws JsonParseException
		{
			return gson().fromJson(json,GuiPersistentStates.class);
		}
		
		
		protected Gson gson()
		{
			return new GsonBuilder().registerTypeAdapter(Object[].class,new ObjectArrayHandler())
