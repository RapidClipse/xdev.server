...
public interface MasterDetail
{
	...
	public class Implementation implements MasterDetail
	{
		...
		@Override
		public <T> void connectForm(final AbstractSelect master, final BeanFieldGroup<T> detail)
		{
			master.addValueChangeListener(e -> prepareFormData((T)master.getValue(),detail));
		}
		
		
		protected <T> void prepareFormData(final T data, final BeanFieldGroup<T> detail)
		{
